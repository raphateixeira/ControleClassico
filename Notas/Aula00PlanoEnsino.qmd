...
::: {.callout-note}
Domínio **contínuo**, com a **função de transferência** como modelo central. Continua em Controle II (espaço de estados, controle digital).
:::
...
::: {.columns}
::: {.column width="60%"}
- Conceito de controle automático; componentes do sistema (planta, atuador, sensor, controlador)
- Sistemas em malha aberta e em malha fechada; realimentação negativa
- Sinais e variáveis do sistema: referência, erro, sinal de controle, perturbação
- Objetivos de projeto: estabilidade, resposta transitória e erro de regime permanente
- Breve histórico do controle automático
:::
::: {.column width="40%"}
```{tikz}
%| echo: false
...
## Unidade 2 — Modelagem e Função de Transferência

- Revisão da Transformada de Laplace: propriedades e pares notáveis
- Função de transferência: definição, polos e zeros, equação característica
- Modelagem de sistemas mecânicos (massa-mola-amortecedor) e eletromecânicos (motor CC)
- Diagrama de blocos: elementos, álgebra de blocos (série, paralelo, realimentação)
- Redução de diagramas com múltiplas malhas aninhadas
...
## Unidade 3 — Resposta Transitória e Erro de Regime Permanente

::: {.columns}
::: {.column width="60%"}
- Sistemas de 1ª e 2ª ordem: constante de tempo, frequência natural, amortecimento; classificação (sub, criticamente, sobreamortecido)
- Especificações de desempenho: sobressinal, tempo de pico, de acomodação e de subida
- Ordem superior: polos dominantes; efeito de polos e zeros adicionais
- Erro de regime permanente: teorema do valor final; tipo de sistema; constantes de erro estático
:::
::: {.column width="40%"}
![Erro de regime em sistema Tipo 0 e Tipo 1](imgs/plots/fig_erro_tipo_stack.png){width="85%" fig-align="center"}
:::
:::

---

## Unidade 4 — Estabilidade e Lugar Geométrico das Raízes (LGR)

::: {.columns}
::: {.column width="60%"}
- Estabilidade BIBO; critério de Routh-Hurwitz e seus casos especiais
- Condições de ângulo e de módulo; regras de construção do LGR
- Assíntotas, pontos de quebra, ângulos de partida/chegada, cruzamento do eixo imaginário
- Projeto de ganho por LGR
:::
::: {.column width="40%"}
![LGR de $K(s+3)/[s(s+1)(s+5)]$](imgs/plots/fig_lgr_exemplo2.png){width="100%" fig-align="center"}
:::
:::

---

## Unidade 5 — Resposta em Frequência

::: {.columns}
::: {.column width="60%"}
- Diagrama de Bode: assíntotas e fatores básicos
- Margens de ganho e de fase; relação com o amortecimento
- Noção do critério de Nyquist
:::
::: {.column width="40%"}
![Margens de ganho e de fase](imgs/plots/fig_bode_exemplo.png){width="100%" fig-align="center"}
:::
:::
...
::: {.columns}
::: {.column width="60%"}
- Ação proporcional (P), integral (I) e derivativa (D): efeitos individuais sobre a resposta
- Estruturas PI, PD e PID; efeito sobre o tipo do sistema e sobre a estabilidade
- Aspectos práticos: windup integral, ruído na ação derivativa
:::
::: {.column width="40%"}
```{tikz}
%| echo: false
...
::: {.callout-tip}
Avaliações podem incluir questões de **ENADE** e **concursos públicos**.
:::
...
Avaliação: **prova escrita** e **listas de exercícios**.

$$\mathrm{NF} = \dfrac{A_1 + A_2}{2} + P_l$$

- $A_1$ — Prova Bimestral &nbsp;·&nbsp; $A_2$ — Prova Final
- $P_l$ — pontuação de atividades complementares (listas de exercícios)
...
| 10 | 05/10 (seg) | U3 — erro de regime permanente: valor final, tipo de sistema, constantes de erro; lista de exercícios |
...
| 12 | 16/10 (sex) | **Prova Bimestral (A1)** |
...
- 16/10 (sex) — Prova Bimestral (A1)
- 14/12 (seg) — Prova Final (A2)

::: {.callout-important}
Não haverá prova substitutiva nem prova de recuperação.
:::
:::
::: {.column width="50%"}
**Feriados (sem aula)**
