...
::: {.callout-important}
Note que $t_s$ depende apenas de $\sigma=\zeta\omega_n$ (a parte real do polo) — **por isso os polos dominantes** (Aula 6) bastam para estimar $t_s$ em sistemas de ordem superior.
:::
